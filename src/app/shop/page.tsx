      ...
      <section className="bg-ivory py-14 text-center sm:py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <p className="mt-4 leading-relaxed text-text-secondary">
            ...
            <br />
            売上・収益の一部を、地球防衛群の水源保全・里山再生などの活動に役立てています。
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-lg px-4 text-center sm:px-6">
          <div className="rounded-2xl border-2 border-wakakusa/30 bg-white p-8 shadow-sm">
            ...
            <p className="mt-2 text-[11px] leading-relaxed text-text-muted">
              本ショップは外部事業者が運営するサイトです。商品購入、配送、返品、決済、個人情報の取扱いについては、移動先サイトの規約およびプライバシーポリシーをご確認ください。対象商品の売上の一部または運営者からの協賛金が、一般財団法人 地球防衛群の活動支援に充てられます。支援内容は商品・企画ごとに異なります。
            </p>
          </div>
        </div>
      </section>
