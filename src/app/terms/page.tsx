    ...
    <>
      ...
      <section className="bg-ivory py-16 sm:py-24">
        <article className="mx-auto max-w-3xl px-4 text-text-secondary sm:px-6">
          ...
          <p className="mt-3 text-sm leading-relaxed">
            当財団は、本サイトの利用または利用不能により利用者に生じた損害について、当財団に故意または重過失がある場合を除き、法令上認められる範囲で責任を負いません。
          </p>
          <p className="mt-3 text-sm leading-relaxed">
            本サイトに掲載する情報は、環境保全、防災、地域合意形成に関する一般的な情報提供を目的とするものであり、特定の事業者、行政機関、団体または個人の違法性、故意、過失その他の法的責任を断定するものではありません。事例紹介においては、行政資料、判決文、議会資料、報道資料、関係団体の公表資料等に基づき、可能な限り出典を明示していますが、個別事案の評価や対応については、最新の資料確認および専門家への相談が必要です。
          </p>
          ...
          <p className="mt-3 text-sm leading-relaxed">
            本規約の準拠法は日本法とし、本サイトに関する紛争については、当財団の本店所在地を管轄する裁判所を第一審の専属的合意管轄とします。
          </p>
