...
const activities: Activity[] = [
  ...
  },
  {
    ...
    title: "地域環境への影響が懸念される開発に関する相談・情報整理",
    description:
      "相談受付、専門家との連携、実態調査、情報提供を通じて、地域環境への影響が懸念される開発の抑止に取り組んでいます。地域との調整が不十分なまま進められる大規模開発や山林の伐採など、地域が直面する課題に対して環境相談窓口として寄り添い、必要に応じて弁護士等の専門家への相談につなぐことも視野に入れながら、情報整理や論点整理を支援しています。",
