...
export const MAP_CASES_REFERENCE: MapCase[] = [
  ...
  },
  {
    ...
    topicAnchor: "",
    summary:
      "町の条例違反が公表され、地域住民の反対を背景に事業中止・撤退に至ったと報じられている",
  ...
  },
  {
    ...
    topicAnchor: "",
    summary:
      "治水・利水を目的としたダム事業をめぐり、住民移転や地域合意のあり方が長年にわたり論点となっている",
  ...
  },
  {
    ...
    sourceUrl:
      "https://news.yahoo.co.jp/articles/9976f9c1c4334fa044dfd000062620230772694f",
    sourceLabel: "Yahoo!ニュース（STV報道）",
  },
  /* ── 優先度B 追加事案 ─────────────────────── */
  {
    id: "zao-wind",
