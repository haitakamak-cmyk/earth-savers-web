...
export const MAP_CASES_TOPIC: MapCase[] = [
  ...
  },
  {
    ...
    lng: 135.6983,
    category: "solar",
    status: "大阪高裁が開発許可取消しを命じる判決（2026年6月）",
    topicAnchor: "35-奈良県平群町メガソーラー係争中の事案",
    summary: "造成地からの土砂流出をめぐる訴訟で、2026年6月に大阪高裁が開発許可の取消しを命じた事案。判決確定状況は要確認",
  },
  {
    id: "hokuto",
    sectionRef: "3.6",
  ...
  },
  {
    ...
    lng: 133.845,
    category: "solar",
    status: "環境アセス手続着手後、近年の進捗を公的資料で確認できず",
    topicAnchor: "37-岡山県岡山市足守地区仮称大規模太陽光発電事業",
    summary: "景観・防災が論点となった大規模太陽光計画。事業継続状況は要確認",
  },
  {
    id: "mimasaka",
    sectionRef: "3.8",
...
export const MAP_CASES_REFERENCE: MapCase[] = [
  ...
  },
  {
    ...
    lng: 140.758,
    category: "wind",
    status: "2024年5月に商業運転開始",
    topicAnchor: "",
    summary: "出力42,000kWの風力発電所。2026年3月には風車部品の脱落事故が公表され、事業者は修復済み・運転への支障なしとしている",
    sourceUrl: "https://www.eneos-re.com/miyagi_kami/news/202603-1.php",
    sourceLabel: "事業者（発電所情報・部品脱落事案）",
  },
  {
    id: "hakkoda-wind",
    sectionRef: "",
    prefecture: "青森県",
    city: "八甲田周辺",
    title: "八甲田周辺 陸上風力計画（みちのく風力）",
    lat: 40.655,
    lng: 140.876,
    category: "wind",
    status: "2023年10月に計画撤回・事業廃止",
    topicAnchor: "",
    summary: "事業者が地域・自治体からの意見を踏まえ、環境影響評価手続を含め事業を取りやめたと公表",
    sourceUrl: "https://www.eurus-energy.com/news/2023/20231010-1693.html",
    sourceLabel: "事業者（事業取りやめ）",
  },
  {
    id: "yuza-offshore",
    sectionRef: "",
    ...
    lng: 139.873,
    category: "wind",
    status: "事業者選定済（2024年12月）",
    topicAnchor: "",
    summary: "国の促進区域で、山形遊佐洋上風力合同会社が選定された。地域との協議を継続中",
    sourceUrl: "https://www.town.yuza.yamagata.jp/archive/contents-1480",
    sourceLabel: "遊佐町（選定結果）",
  },
  {
    id: "yura-wind",
    sectionRef: "",
