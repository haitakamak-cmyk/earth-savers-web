...
export const POLICIES: readonly PolicyEntry[] = [
  {
    ...
    summary:
      "田んぼをやめると、消えるのは米だけではない。雨水を受け止め、地下の水を養い、生きものを支え、豪雨のときに流出を和らげる側の基盤も、いっしょに失われていく。それでもこれらの働きは食料・治水・防災・生態系の別々の制度に分かれ、全体を引き継ぐ責任の所在が見えにくい。本提言は、農地を食・水・生態系・防災の国土インフラとして捉え直し、その公共機能に公が対価を支払う仕組みを求める。その対価は、販売収入だけに頼らずに農業を続けられる所得の土台にもなる。設計の単位は流域、測る軸は100年、動かす周期は20年とする。",
